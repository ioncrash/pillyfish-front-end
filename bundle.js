...
/***/ function(module, exports, __webpack_require__) {
	...
	var onMedClick = function onMedClick(e) {
	  e.preventDefault();
	  var data = getFormFields(this);
	...
	var createMed = function createMed(e) {
	  e.preventDefault();
	  var data = getFormFields(this);
	  api.create(data).then(ui.createMedSuccess).catch(ui.failure);
	  $('#create-med-modal').modal('hide');
	  indexMeds(e);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"row\">\n  <div class=\"col-xs-12 col-sm-6 med-row\"  data-toggle=\"modal\" data-target=\"#med-"
