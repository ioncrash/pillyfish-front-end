...
/***/ function(module, exports, __webpack_require__) {
	...
	var medEvents = __webpack_require__(9);

	$(function () {
	  authEvents.addAuthHandlers();
	  medEvents.addMedHandlers();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var meds = __webpack_require__(9);

	var onSignUp = function onSignUp(e) {
	  e.preventDefault();
	  var data = getFormFields(this);
	  var credentials = data;
	  api.signUp(data).then(ui.success).then(api.signIn(credentials).then(ui.signInSuccess)).catch(ui.failure);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexMeds = function indexMeds(e) {
	  e.preventDefault();
	  api.index().then(ui.indexMedsSuccess).catch(ui.failure);
	};

	var changeMed = function changeMed(e) {
	  e.preventDefault();
	  var data = getFormFields(event.target);
	  data.med.id = $(event.target).data().medId;
	  api.update(data).then(ui.changeMedSuccess).then(function () {
	    indexMeds(e);
	  }).catch(ui.failure);
	...
	var createMed = function createMed(e) {
	  e.preventDefault();
	  var data = getFormFields(this);
	  api.create(data).then(ui.createMedSuccess).then(function () {
	    indexMeds(e);
	  }).catch(ui.failure);
	  $('#create-med-modal').modal('hide');
	};

	var deleteMed = function deleteMed(e) {
	  e.preventDefault();
	  var id = $(this).data().medId;
	  api.deleteMed(id).then(ui.deleteMedSuccess).then(function () {
	    indexMeds(e);
	  }).catch(ui.failure);
	  $('.change-med-modal').modal('hide');
	  $('body').removeClass('modal-open');
	...
	var addMedHandlers = function addMedHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteMed = function deleteMed(id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexMedsTemplate = __webpack_require__(12);

	var changeMedSuccess = function changeMedSuccess(data) {
	  console.log(data);
	};
	...
	var indexMedsSuccess = function indexMedsSuccess(meds) {
	  $('.med-grid').html(indexMedsTemplate(meds));
	};

	var deleteMedSuccess = function deleteMedSuccess() {
	  console.log('whee!');
	};

	module.exports = {
	  indexMedsSuccess: indexMedsSuccess,
	  changeMedSuccess: changeMedSuccess,
	  deleteMedSuccess: deleteMedSuccess,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"row\" data-toggle=\"modal\" data-target=\"#med-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "-modal\">\n  <div class=\"col-xs-6 med-row\">"
	    ...
	    + "</div>\n</div>\n\n<div class=\"modal fade change-med-modal\" id=\"med-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"med-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "-modal\">\n<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n      <h4 class=\"modal-title\">Change med: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.nickname : stack1), depth0))
	    + " ("
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.clinical_name : stack1), depth0))
	    + ")</h4>\n    </div>\n    <div class=\"modal-body\">\n      <form class=\"change-med-form\" data-med-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <div class=\"form-group\">\n          <label for=\"med-nickname\">Nickname</label>\n          <input type=\"text\" class=\"form-control\" name=\"med[nickname]\" id=\"change-med-nickname\" placeholder=\"What do you call this med?\">\n        </div>\n        <div class=\"form-group\">\n          <label for=\"change-med-clinical-name\">Clinical Name</label>\n          <input type=\"text\" class=\"form-control\" id=\"create-med-clinical_name\" name=\"med[clinical_name]\" placeholder=\"What does your phamacist call it?\">\n        </div>\n        <div class=\"form-group\">\n          <label for=\"change-med-count\">Count</label>\n          <input type=\"text\" class=\"form-control\" id=\"create-med-count\" name=\"med[count]\" placeholder=\"How many do you have?\">\n        </div>\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n        <button type=\"submit\" class=\"btn btn-default\">Submit</input>\n        <button type=\"button\" class=\"btn btn-default delete-btn\" data-med-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.meds : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
